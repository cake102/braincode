            ...
            <Flex>
              <div style="width:80%">
                ...
                <span>
                  ...
                  <span class="point-text">Tambah Data Point</span>
                </Flex>
              </div>
              <div class="w20">
  ...
  Lengkapi isian form terlebih dahulu !
            ...
            <div id="popup-container-gis-add" style={{ display: 'none' }}>
              <div class="popup-container">
                <Flex>
                  ...
                  <div>
                    <Button id="myButton" class="btgis" leftIcon={<AiOutlinePlus boxSize={18} class="bttn-tmbh" />}>
        ...
        <ModalContent>
          ...
          <div class="container-clmn">
             <Input onChange={handleChangeLokasi} class="clmn-text" placeholder="Lokasi" _placeholder={{
              color: 'rgb(114 114 114) !important',
             }} size="sm" />
             </div>
             <div class="container-clmn">
             <Input onChange={handleChangeTitik} class="clmn-text" placeholder="Titik"   _placeholder={{
             color: 'rgb(114 114 114) !important',
             }}  size="sm" />
             </div>
             <div class="container-clmn">
             <Input onChange={handleChangeJenis} class="clmn-text" placeholder="Jenis"   _placeholder={{
             color: 'rgb(114 114 114) !important',
             }}  size="sm" />
             </div>
             <div class="clmn-batas">
             <Input onChange={handleChangeBatas} class="clmn-text" placeholder="Batas"   _placeholder={{
             color: 'rgb(114 114 114) !important',
             }}  size="sm" />
             </div>
