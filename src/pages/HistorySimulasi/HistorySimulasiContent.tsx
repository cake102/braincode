...
const HistorySimulasiContent: Component<HistorySimulasiContentProps> = (props) => {
  ...
  return (
    <>
      <div class="fl">
        <div class="style-height-contain">
          <Flex>
            <div class="style-cntnt">
              <span class="margin-span">Ly Thai To</span>
            </div>
            <div class="style-txt-margin">
              <div>
                <Flex>
                  <div class="dctl width-flex-dctl">
                  ...
                  <div class="dct wdth-dct">
                    <span>Durasi : </span> <span>48H 40M 00S</span>
                  </div>
                  <div class="dctr flag-img-dct">
                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div>
                <Flex>
                  <div class="dct wdth-txt-dct">
                    <span>Kepulauan Bangka Belitung</span>
                  </div>
                  <div class="dct wdth-dct1">
                  <span>Jarak : </span> <span>2091 KM</span>
                  </div>
                  <div class="dct wdth-dct2">
                  <span>Kalimantan Selatan</span>
                  </div>
                </Flex>
              </div>
            </div>
            <div class="style-btn-ontr">
              <Button class="btstaty-lsct btstaty-lsct-margin ">
                <span>On Track</span>
              </Button>
            </div>
          </Flex>
        ...
        <div>
          <Flex >
            <div class="box-width-style" >
              <div class="flc style-box-shd">
                <div class="marg-kapal-lythai">Tracking Kapal Ly Thai To</div>
                <div class="font-style-kapal-lythiao">
...
">{step.tanggal}</div>
                                ...
                                <div class="style-step-waktu">
                                  <div class="      mg-style-waktu">{step.waktu}</div>
                                  <div>{step.tempat}</div>
                        ...
                        >
                          <Flex >
                            <div class="style-step-tgl
">{step.tanggal}</div>
                            <div class="style-wd-st-tgl">
                              <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="15" cy="15" r="15" fill="#699BF7" fill-opacity="0.4" />
                                <circle cx="14.5" cy="14.5" r="7.5" fill="#699BF7" />
                              </svg>
                            </div>
                            <div class="style-font-step-waktu
">
                              <div class="mgtop-step-waktu ">{step.waktu}</div>
                              <div>{step.tempat}</div>
                            </div>
                          </Flex>
...
">
              ...
              <div class="flc style-flc-box123">
      <div class="font-style-informasi">Informasi Umum Kapal</div>
      <div>
        <Flex>
          <div class="style-wd-txt-alg">
          <img src={`/public/pp.png`} />
          </div>
          <div class="style-kapten-alex">
      ...
      <div class=" style10">
        <Flex class="flex-style01 ">
          <div style="width:50%">
          <span class="font-model-cntnt">Model : </span>
          <span>Ly Thai To</span>
          </div>
          <div style="width:50%">
          <span class="font-model-cntnt12">Dimensi : </span>
          <span>102 x 13 x 5.3 m</span>
          </div>
        </Flex>
        <Flex class="flexStyle">
          <div style="width:50%">
